...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int loop = -1; //entrar no loop das opcoes
        
        System.out.println("Bem-vindo ao seu programa de notas escolares. Para ultiliza-lo insira o numero de acordo com a opcao que deseja.");
        ...
        while (loop != 0){
            ...
            System.out.println("\nMenu\n"
                    + "\n1: Criar ou verificar existencia da disciplina;"
                    + "\n2: Inserir aluno;"
                    + "\n3: Gerar notas;"
                    + "\n0: Fechar programa.");
            loop = ler.nextInt();
            ...
            if (loop == 0)
                ...
                if (d.arquivoExistente(nomeDisciplina))
                    System.out.println("Essa disciplina ja existe e seu gabarito esta armazenado em: c:\\" + nomeDisciplina + "\\gabarito.txt"
                            + "\nPara reescrever seu gabarito, insira seu nome novamente na nova cria̤̣o de uma nova disciplina");
                else 
                ...
                System.out.println("Se deseja voltar ao menu insira 0, se deseja criar uma nova disciplina insira 1.");
                    ...
                    if (escolhaDisciplina == 1){
                        ...
                        d.criarDiretorio();
                        System.out.print("Agora, insira o gabarito da disciplina, sem espacos e em caixa alta: ");
                ...
                if (d.arquivoExistente(nomeDisciplina)){                
                    ...
                    while (loopAluno != 0){
                        ...
                        while (respostasAluno.length() != 10){
                            System.out.println("Voce nao digitou DEZ respostas. Tente novamente.");
                            respostasAluno = ler.next();
                        }
                ...
                if (d.arquivoExistenteAluno(escolhaNotas)){
                    ...
                    System.out.println("Essa disciplina nao existe ou nao possui alunos!");
            }   
            else 
